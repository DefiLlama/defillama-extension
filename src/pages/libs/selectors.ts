...
export const POLYGON_SELECTORS: EtherscanAlikeSelectors = {
  address: {
    erc20: {
      test: "#ContentPlaceHolder1_tr_tokeninfo",
      appendTo: "#ContentPlaceHolder1_tr_tokeninfo > div > div.col-md-8 > a",
...
export const CRONOS_SELECTORS: EtherscanAlikeSelectors = {
  address: {
    erc20: {
      test: "#ContentPlaceHolder1_tr_tokeninfo",
      appendTo: "#ContentPlaceHolder1_tr_tokeninfo > div > div.col-md-8 > a",
...
export const GNOSIS_SELECTORS: EtherscanAlikeSelectors = {
  address: {
    erc20: {
      test: "#ContentPlaceHolder1_tr_tokeninfo",
      appendTo: "#ContentPlaceHolder1_tr_tokeninfo > div > div.col-md-8 > a",
...
export const AURORA_SELECTORS: EtherscanAlikeSelectors = {
  address: {
    erc20: {
      test: "#ContentPlaceHolder1_tr_tokeninfo",
      appendTo: "#ContentPlaceHolder1_tr_tokeninfo > div > div.col-md-8 > a",
